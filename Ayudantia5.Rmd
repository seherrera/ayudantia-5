...
Para el análisis de clusters vamos a analizar la data de  “sanguchez.csv” que contiene la información de los pokemones de 7 de sus generaciones, echaremos un vistazo a las variables presentes.
```{r load data}
library(tidyverse)
